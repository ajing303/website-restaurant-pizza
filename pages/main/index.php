     ...
     <a href="index.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?> "style="text-decoration: none;">
      ...
      <p class="price_product"><?php echo number_format($row['giasp'],0,',','.').'₫' ?></p>
       <div class="btn">
         ...
         <p><input class="themgiohang" name="themgiohang" type="submit" value="Mua hàng" style="font-family: Montserrat"></input></p> 
           </div></form>  
           </a>     
    </li>
...
<div style="clear:both;"></div>
 <?php
      ...
      ?>
        ...
        <ul class="list_trang">
          <p style="    font-family: Montserrat; font-size: 20px; color: gray">Trang: <?php echo $page ?>/<?php echo $trang ?> </p>
          <?php
            for($i=1;$i<=$trang;$i++){
          ?>
